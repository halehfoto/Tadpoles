...
close all
% path=uigetdir;
path='C:\Users\Haleh\OneDrive - Harvard University\Documents\Tadpole Data\habituation\20210928'
cd(path)
%read the avi file
filename='WIN_20210928_13_51_30_Pro.mp4';
...
st=smooth(Imstd{i}(1:nFrames-1),50);
for i=1:numwells
    plot(time(round(10*v.FrameRate):nFrames-50),detrend(st(round(10*v.FrameRate):nFrames-50)),'Color',color(i,:),'LineWidth',1)
    xlabel('Time (s)') 
...
% figure
% multcompare(STATS)
save('WIN_20210928_13_51_30_Pro.mat')

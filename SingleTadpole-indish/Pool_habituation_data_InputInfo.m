...
for i=1:length(filenames_Pre{3})
    ...
    Resp_Pre_D3=[Resp_Pre_D3;d.Resp(:,1:20)];
end
...
if Stim_In
    ...
    for i=1:length(filenames_in{3})
        ...
        Resp_in_D3=[Resp_in_D3;d.Resp(:,1:20)];
    end
end
...
for i=1:length(filenames_3h{3})
    ...
    Resp_3h_D3=[Resp_3h_D3;d.Resp(:,1:20)];
end
Resp_5h_D3=[];
for i=1:length(filenames_5h{3})
    d=load(filenames_5h{3}(i).name);
    Resp_5h_D3=[Resp_5h_D3;d.Resp(:,1:20)];
end


resp_prob_Pre_D3=nanmean(Resp_Pre_D3,1);
figure;title('Control'); plot(resp_prob_Pre_D3,'*');hold on
f=fit((1:1:20)',(resp_prob_Pre_D3)','exp1');plot(f,(1:1:20)',(resp_prob_Pre_D3)')

if Stim_In
    resp_prob_in_D3=nanmean(Resp_in_D3,1);

    plot((21:1:40)',resp_prob_in_D3,'*');hold on
    f=fit((21:1:40)',(resp_prob_in_D3)','exp1');plot(f,(21:1:40)',(resp_prob_in_D3)')
end
if ~isempty(Resp_2h_D3)
    resp_prob_2h_D3=nanmean(Resp_2h_D3,1);
    plot((41:1:60)',resp_prob_2h_D3,'*');hold on
    f=fit((41:1:60)',(resp_prob_2h_D3)','exp1');plot(f,(41:1:60)',(resp_prob_2h_D3)')
end
...
for i=1:length(filenames_Pre{4})
    ...
    Resp_Pre_D4=[Resp_Pre_D4;d.Resp(:,1:20)];
end
...
if Stim_In
    ...
    for i=1:length(filenames_in{4})
        ...
        Resp_in_D4=[Resp_in_D4;d.Resp(:,1:20)];
    end
end
...
for i=1:length(filenames_3h{4})
    ...
    Resp_3h_D4=[Resp_3h_D4;d.Resp(:,1:20)];
end
Resp_5h_D4=[];
for i=1:length(filenames_5h{4})
    d=load(filenames_5h{4}(i).name);
    Resp_5h_D4=[Resp_5h_D4;d.Resp(:,1:20)];
end


resp_prob_Pre_D4=nanmean(Resp_Pre_D4,1);
figure;title('Control'); plot(resp_prob_Pre_D4,'*');hold on
f=fit((1:1:20)',(resp_prob_Pre_D4)','exp1');plot(f,(1:1:20)',(resp_prob_Pre_D4)')

if Stim_In
    resp_prob_in_D4=nanmean(Resp_in_D4,1);

    plot((21:1:40)',resp_prob_in_D4,'*');hold on
    f=fit((21:1:40)',(resp_prob_in_D4)','exp1');plot(f,(21:1:40)',(resp_prob_in_D4)')
end
if ~isempty(Resp_2h_D4)
    resp_prob_2h_D4=nanmean(Resp_2h_D4,1);
    plot((41:1:60)',resp_prob_2h_D4,'*');hold on
    f=fit((41:1:60)',(resp_prob_2h_D4)','exp1');plot(f,(41:1:60)',(resp_prob_2h_D4)')
end
if ~isempty(Resp_3h_D4)
    resp_prob_3h_D4=nanmean(Resp_3h_D4,1);
    plot((61:1:80)',resp_prob_3h_D4,'*');hold on
    f=fit((61:1:80)',(resp_prob_3h_D4)','exp1');plot(f,(61:1:80)',(resp_prob_3h_D4)')
end

...
filenames_5h_C=dir(strcat('*_C*_5h_Post',stimstr,'_5h_analyzed.mat'));
...
for i=1:length(Drugs)
    filenames_Pre{i}=[dir(strcat('*D',num2str(i),'*_Pre',stimstr,'_5h_analyzed.mat'));dir(strcat('*D',num2str(i),'*_Pre',stimstr,'_7h_analyzed.mat'))];
    ...
    filenames_5h{i}=dir(strcat('*D',num2str(i),'*_5h_Post',stimstr,'_5h_analyzed.mat'));
    filenames_7h{i}=dir(strcat('*D',num2str(i),'*_7h_Post',stimstr,'_7h_analyzed.mat'));

    filenames_Pre_baseline{i}=[dir(strcat('*D',num2str(i),'*_Pre_baseline',stimstr,'_5h_analyzed.mat'));dir(strcat('*D',num2str(i),'*_Pre_baseline',stimstr,'_7h_analyzed.mat'))];
    ...
    filenames_5h_baseline{i}=dir(strcat('*D',num2str(i),'*_5h_Post_baseline',stimstr,'_5h_analyzed.mat'));
    filenames_7h_baseline{i}=dir(strcat('*D',num2str(i),'*_7h_Post',stimstr,'_7h_analyzed.mat'));
...
if ~isempty(Resp_5h_C)
    resp_prob_5h_C=nanmean(Resp_5h_C,1);
    plot((31:1:sum(~isnan(resp_prob_5h_C))+30)',resp_prob_5h_C(1:sum(~isnan(resp_prob_5h_C))),'*');hold on
    f=fit((31:1:sum(~isnan(resp_prob_5h_C))+30)',(resp_prob_5h_C(1:sum(~isnan(resp_prob_5h_C))))','exp1');plot(f,(31:1:sum(~isnan(resp_prob_5h_C))+30)',(resp_prob_5h_C(1:sum(~isnan(resp_prob_5h_C))))')
end
...
Resp_7h_D1=[];
for i=1:length(filenames_7h{1})
    d=load(filenames_7h{1}(i).name);
    Resp_7h_D1=[Resp_7h_D1;d.Resp(:,1:20)];
end
...
% end
% 
% if ~isempty(Resp_7h_D1)
%     resp_prob_7h_D1=nanmean(Resp_7h_D1,1);
%     plot((101:1:120)',resp_prob_7h_D1,'*');hold on
%     f=fit((101:1:120)',(resp_prob_7h_D1)','exp1');plot(f,(101:1:120)',(resp_prob_7h_D1)')
% end
if ~isempty(Resp_5h_D1)
    resp_prob_5h_D1=nanmean(Resp_5h_D1,1);
    plot((31:1:50)',resp_prob_5h_D1,'*');hold on
    f=fit((31:1:50)',(resp_prob_5h_D1)','exp1');plot(f,(31:1:50)',(resp_prob_5h_D1)')
end

if ~isempty(Resp_7h_D1)
    resp_prob_7h_D1=nanmean(Resp_7h_D1,1);
    plot((61:1:80)',resp_prob_7h_D1,'*');hold on
    f=fit((61:1:80)',(resp_prob_7h_D1)','exp1');plot(f,(61:1:80)',(resp_prob_7h_D1)')
end
...
Resp_7h_D2=[];
for i=1:length(filenames_7h{2})
    d=load(filenames_7h{2}(i).name);
    if size(d.Resp,2)==20
        Resp_7h_D2=[Resp_7h_D2;d.Resp(:,1:20)];
    else
        Resp_7h_D2=[Resp_7h_D2;[d.Resp(:,1:end),NaN(20,20-size(d.Resp,2))]];
    end
end
...
% end
% if ~isempty(Resp_7h_D2)
%     resp_prob_7h_D2=nanmean(Resp_7h_D2,1);
%     plot((101:1:120)',resp_prob_7h_D2,'*');hold on
%     f=fit((101:1:120)',(resp_prob_7h_D2)','exp1');plot(f,(101:1:120)',(resp_prob_7h_D2)')
% end

if ~isempty(Resp_5h_D2)
    resp_prob_5h_D2=nanmean(Resp_5h_D2,1);
    plot((31:1:50)',resp_prob_5h_D2,'*');hold on
    f=fit((31:1:50)',(resp_prob_5h_D2)','exp1');plot(f,(31:1:50)',(resp_prob_5h_D2)')
end
if ~isempty(Resp_7h_D2)
    resp_prob_7h_D2=nanmean(Resp_7h_D2,1);
    plot((61:1:80)',resp_prob_7h_D2,'*');hold on
    f=fit((61:1:80)',(resp_prob_7h_D2)','exp1');plot(f,(61:1:80)',(resp_prob_7h_D2)')
end
